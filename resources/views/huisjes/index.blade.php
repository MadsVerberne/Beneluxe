...
<body>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
        @foreach ($huisjes as $huisje)
            <!-- Item -->
            <a href="{{ route('huisjes.show', $huisje->id) }}">
                <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <h2 class="text-xl font-semibold mb-2">{{ $huisje->titel }}</h2>
                        <p class="text-gray-600 mb-1">{{ $huisje->locatie }}</p>
                        <p class="text-gray-600">€{{ $huisje->prijs_per_nacht }}</p>
                    </div>
                </div>
            </a>
        @endforeach

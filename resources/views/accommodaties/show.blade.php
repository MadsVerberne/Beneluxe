    ...
    <div class="row1">
        ...
        <div class="price-summary-card">
            <div class="price-summary-header">
                ...
                <span class="per-night-text">· {{ $aantalNachten }} nacht{{ $aantalNachten > 1 ? 'en' : '' }}</span>
            </div>
            ...
            <div class="price-breakdown">
                <div class="breakdown-item">
                    <span>€ {{ $accommodatie->prijs_per_nacht }} x {{ $aantalNachten }} nacht{{ $aantalNachten > 1 ? 'en' : '' }}</span>
                    <span>€ {{ number_format($subtotaal, 2, ',', '.') }}</span>
                </div>
                <div class="breakdown-item">
                    <span>Schoonmaakkosten</span>
                    <span>€ {{ number_format(150, 2, ',', '.') }}</span>
                </div>
                <div class="breakdown-item">
                    <span>Servicekosten</span>
                    <span>€ {{ number_format(270, 2, ',', '.') }}</span>
                </div>
